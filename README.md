...
| show_color_bar       | boolean         | **Optional** | Show the radar colour scale (NOAA / RainViewer use a horizontal strip; DWD overlays the official per-layer legend on the map)                                                                                                                                | `true`                                |
