...
// mdi:lightning-bolt — used by the lightning overlay for the first 30 s
// of a strike's life (the "happening now" indicator, paired with the
// pulse animation). After 30 s the layer swaps to LIGHTNING_PLUS_PATH
// (matching Blitzortung's own web-map convention — coloured + signs).
export const LIGHTNING_BOLT_PATH = 'M11,15H6L13,1V9H18L11,23V15Z';

// mdi:plus-thick — the steady-state strike marker after the 30 s bolt
// window. Mirrors Blitzortung's web map (chunky filled + signs ageing
// through a colour gradient). We use plus-THICK over plain plus
// (M19,13H13V19H11V13...) because the 4-unit arm width carries enough
// visual weight at 14 px to read with a black outline; plain plus's
// 2-unit arms vanish into the stroke.
export const LIGHTNING_PLUS_PATH = 'M20,14H14V20H10V14H4V10H10V4H14V10H20V14Z';
